 ...
 * DO NOT SPEND TIME ON THIS CODE UNTIL YOU HAVE A MOSTLY WORKING
 ...
 Updated - F. Estrada, Oct. 2025. - somehow my summer update got lost :(
...
{ 
 ...
 if (key=='i') {if (DIR_FWD==0) {DIR_FWD=1; DIR_L=0; DIR_R=0; DIR_BACK=0; BT_drive(LEFT_MOTOR, RIGHT_MOTOR,75, 75);} else {DIR_FWD=0; BT_all_stop(0);}}
 ...
 if (key=='k') {if (DIR_BACK==0) {DIR_BACK=1; DIR_L=0; DIR_R=0; DIR_FWD=0; BT_drive(LEFT_MOTOR, RIGHT_MOTOR, -75, -75);} else {DIR_BACK=0; BT_all_stop(0);}}
